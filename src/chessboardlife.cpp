...
{
	// Сущность ent (обычно это событие или действие) добавляется в текущий временной фрейм
	// истории, хранящейся в агенте.
...
void Agent::step()
{
	...
	// создаём новый временной фрейм, при необходимости удаляя самый старый
